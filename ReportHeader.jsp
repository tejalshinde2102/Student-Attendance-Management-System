...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="index.jsp">SmartAttendanceSystem</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <% if (isLoggedIn) {%>
                <li class="nav-item"><a class="nav-link" href="../Reports/AdminDashboard.jsp"><i class="fa fa-home"></i> Home</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="../ManageSubjects.jsp"><i class="fa fa-file-alt"></i> Subjects</a></li>
                ...
                <li class="nav-item"><a href="../AdminLogout.jsp" class="btn btn-danger ms-2">Logout</a></li>
                    <% } else { %>
